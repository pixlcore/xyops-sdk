...
<!-- toc -->
- [xyOps SDK for Node.js](#xyops-sdk-for-nodejs)
	* [Installation](#installation)
	* [Job Runtime SDK](#job-runtime-sdk)
		+ [Basic Job](#basic-job)
		+ [Reading Input](#reading-input)
			- [job.read](#jobread)
			- [job.getParams](#jobgetparams)
			- [job.getParam](#jobgetparam)
			- [job.getFiles](#jobgetfiles)
			- [job.getData](#jobgetdata)
			- [job.getWorkflowData](#jobgetworkflowdata)
		...
		+ [Sending Output Data](#sending-output-data)
			...
			- [job.addServerData](#jobaddserverdata)
		+ [Attaching Files](#attaching-files)
			- [job.addFile](#jobaddfile)
			- [job.addFiles](#jobaddfiles)
		+ [Tags and Actions](#tags-and-actions)
			- [job.addTag](#jobaddtag)
			- [job.addTags](#jobaddtags)
			- [job.addAction](#jobaddaction)
			- [job.addActions](#jobaddactions)
		+ [Custom Job Content](#custom-job-content)
			- [job.setTable](#jobsettable)
			- [job.setHTML](#jobsethtml)
			- [job.setText](#jobsettext)
			- [job.setMarkdown](#jobsetmarkdown)
	...
	* [API Client](#api-client)
		...
		+ [Streaming a Live Job](#streaming-a-live-job)
	* [API Catalog](#api-catalog)
		...
		+ [Buckets](#buckets)
			...
			- [writeBucketData](#writebucketdata)
			- [uploadBucketFiles](#uploadbucketfiles)
		...
		+ [Groups](#groups)
			...
			- [createGroupSnapshot](#creategroupsnapshot)
		+ [Jobs](#jobs)
			- [getActiveJobs](#getactivejobs)
			- [getActiveJobSummary](#getactivejobsummary)
			- [getWorkflowJobSummary](#getworkflowjobsummary)
			- [getJob](#getjob)
			- [getJobs](#getjobs)
			- [getJobLog](#getjoblog)
			- [streamJob](#streamjob)
		...
		+ [Monitors](#monitors)
			...
			- [getQuickmonData](#getquickmondata)
			- [getLatestMonitorData](#getlatestmonitordata)
			- [getHistoricalMonitorData](#gethistoricalmonitordata)
		+ [Plugins](#plugins)
		...
		+ [Search](#search)
			...
			- [searchStatHistory](#searchstathistory)
			- [bulkSearchExport](#bulksearchexport)
		...
		+ [Servers](#servers)
			- [getServerSummaries](#getserversummaries)
		...
		+ [Tickets](#tickets)
			...
			- [addTicketChange](#addticketchange)
			- [updateTicketChange](#updateticketchange)
			- [uploadUserTicketFiles](#uploaduserticketfiles)
			- [deleteTicketFile](#deleteticketfile)
